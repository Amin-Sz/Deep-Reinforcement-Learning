...
class ActorNetwork(tf.keras.Model):
    def __init__(self, state_dims, n_actions, fc1_dims=256, fc2_dims=256, learning_rate=5e-6):
...
def main(training):
    ...
    solved_score = 200
    dir_ = 'Section 1 - Actor-Critic/LunarLander-v2'
    gamma = 0.99
    ...
    if training:
        ...
        plt.show()
        plt.savefig(dir_ + '/Rewards_LunarLander-v2')
