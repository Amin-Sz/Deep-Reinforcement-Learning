    ...
    if training:
        ...
        for t in range(n_iteration):
            ...
            if np.mean(reward_set[-100:]) > best_avg_score:
                ...
                T.save(agent.critic_1.state_dict(), 'Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/critic_1')
                T.save(agent.critic_2.state_dict(), 'Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/critic_2')
                T.save(agent.actor.state_dict(), 'Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/actor')
                T.save(agent.target_critic_1.state_dict(), 'Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/target_critic_1')
                T.save(agent.target_critic_2.state_dict(), 'Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/target_critic_2')
                T.save(agent.target_actor.state_dict(), 'Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/target_actor')

        # Plotting the results
        axes = plt.axes()
        axes.set_ylim([np.min(reward_set) - 500, np.max(reward_set) + 100])
        plt.xlabel('Episode')
        plt.ylabel('Reward')
        ...
        plt.show()
        plt.savefig('Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/Rewards_HopperPyBulletEnv')
        ...
        agent.critic_1.load_state_dict(T.load('Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/critic_1'))
        agent.critic_2.load_state_dict(T.load('Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/critic_2'))
        agent.actor.load_state_dict(T.load('Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/actor'))
        agent.target_critic_1.load_state_dict(T.load('Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/target_critic_1'))
        agent.target_critic_2.load_state_dict(T.load('Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/target_critic_2'))
        agent.target_actor.load_state_dict(T.load('Section 8 - LSTM-TD3/HopperPyBulletEnv-v0/target_actor'))
