    ...
    if training:
        ...
        for t in range(n_iteration):
            ...
            if np.mean(reward_set[-100:]) > best_avg_score:
                ...
                T.save(agent.critic_1.state_dict(), 'HopperPyBulletEnv-v0/critic_1')
                T.save(agent.critic_2.state_dict(), 'HopperPyBulletEnv-v0/critic_2')
                T.save(agent.actor.state_dict(), 'HopperPyBulletEnv-v0/actor')
                T.save(agent.target_critic_1.state_dict(), 'HopperPyBulletEnv-v0/target_critic_1')
                T.save(agent.target_critic_2.state_dict(), 'HopperPyBulletEnv-v0/target_critic_2')
                T.save(agent.target_actor.state_dict(), 'HopperPyBulletEnv-v0/target_actor')
        ...
        plt.show()
        plt.savefig('HopperPyBulletEnv-v0/Rewards_HopperPyBulletEnv')
        ...
        agent.critic_1.load_state_dict(T.load('HopperPyBulletEnv-v0/critic_1'))
        agent.critic_2.load_state_dict(T.load('HopperPyBulletEnv-v0/critic_2'))
        agent.actor.load_state_dict(T.load('HopperPyBulletEnv-v0/actor'))
        agent.target_critic_1.load_state_dict(T.load('HopperPyBulletEnv-v0/target_critic_1'))
        agent.target_critic_2.load_state_dict(T.load('HopperPyBulletEnv-v0/target_critic_2'))
        agent.target_actor.load_state_dict(T.load('HopperPyBulletEnv-v0/target_actor'))
