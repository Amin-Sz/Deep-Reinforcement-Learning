...
class Policy(nn.Module):
    def __init__(self, state_dims, action_dims, action_max, fc1_dims):
        ...
        self.fc2 = nn.Linear(self.fc1_dims, self.action_dims)
    ...
    def forward(self, state):
        ...
        output = T.tanh(self.fc2(output)) * self.action_max
...
class EvolutionStrategies:
    def __init__(self, n_threads, n_workers, state_dims, action_dims, action_max, fc1_dims,
        ...
        self.global_policy = Policy(state_dims=self.state_dims, action_dims=self.action_dims,
                                    action_max=self.action_max, fc1_dims=self.fc1_dims)
...
def main(training: bool):
    ...
    es = EvolutionStrategies(n_threads=n_threads, n_workers=n_workers, state_dims=env.observation_space.shape[0],
                             ...
                             fc1_dims=fc1_dims, initial_learning_rate=initial_learning_rate,
