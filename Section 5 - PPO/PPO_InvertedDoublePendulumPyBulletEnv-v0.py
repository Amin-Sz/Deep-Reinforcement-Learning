...
def main(training=True):
    ...
    dir_ = 'Section 5 - PPO/InvertedDoublePendulumPyBulletEnv-v0'
    ...
    if training:
        ...
        axes = plt.axes()
        axes.set_ylim([np.min(reward_set) - 2000, np.max(reward_set) + 500])
        plt.xlabel('Episode')
        ...
        plt.show()
        plt.savefig(dir_ + '/Rewards_InvertedDoublePendulumPyBulletEnv-v0')
