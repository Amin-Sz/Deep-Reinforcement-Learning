...
def main(training):
    ...
    if training:
        ...
        plot_learning_curve(env_name=env_name, directory=chkpt_dir, training_scores=scores_train[:4900],
                            avg_training_scores=avg_scores_train[:4900], test_scores=scores_test[:141])
